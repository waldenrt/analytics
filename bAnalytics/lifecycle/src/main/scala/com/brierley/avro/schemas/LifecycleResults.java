...
public class LifecycleResults extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The period length that the dataset should be split into in number of months, if 'ALL', the file was not split */
  @Deprecated public int timePeriodLength;
   ...
   * @param timePeriodLength The period length that the dataset should be split into in number of months, if 'ALL', the file was not split
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: timePeriodLength = (java.lang.Integer)value$; break;
   ...
   * @return The period length that the dataset should be split into in number of months, if 'ALL', the file was not split
   */
  public java.lang.Integer getTimePeriodLength() {
   ...
   * @param value the value to set.
   */
  public void setTimePeriodLength(java.lang.Integer value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LifecycleResults>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.brierley.avro.schemas.LifecycleResults.Builder setTimePeriodLength(int value) {
    ...
    public LifecycleResults build() {
      try {
        ...
        record.timePeriodLength = fieldSetFlags()[5] ? this.timePeriodLength : (java.lang.Integer) defaultValue(fields()[5]);
